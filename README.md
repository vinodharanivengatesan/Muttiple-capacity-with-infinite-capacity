...
## Output :
![image](https://github.com/vinodharanivengatesan/Muttiple-capacity-with-infinite-capacity/blob/main/prob5.jpeg?raw=true)

## Result : 
The average number of material in the system and in the conveyer and waiting are successfully found
